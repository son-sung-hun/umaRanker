	...
	<br>
		...
		<a href='#' id='img1' style='font-size: 21px; text-decoration:none; color:#3d414d;'>[ 교복 ]</a>
		 ...
		 <ul style="border-color: #3d414d;">
		 	...
		 	<a href="https://www.pixiv.net/tags/${requestScope.umaDetail.uma_tag }/illustrations"  target='_blank'><img id="logo" src="${ pageContext.servletContext.contextPath }/resources/images/pixiv_icon.png" width="25px" height="25px" style="vertical-align:unset; margin-top : 5px;"></a>
		 	<a href="https://umamusume.jp/character/detail/?name=${requestScope.umaLink }"  target='_blank'><img id="logo" src="${ pageContext.servletContext.contextPath }/resources/images/uma_link.png" width="25px" height="25px" style="vertical-align:unset; margin-top : 5px;"></a>
		 	</li>
